...
{
    static icons = {
        none :  {sprite:GM.ICON.NONE, origin:{x:0.25,y:0}, scale:1},
        aim :   {sprite:GM.ICON.AIM, origin:{x:0.5,y:0.5}, scale:1},
        ...
        cook :  {sprite:GM.ICON.TOOL, origin:{x:0.5,y:0.5}, scale:1},
        drink :  {sprite:GM.ICON.TOOL, origin:{x:0.5,y:0.5}, scale:1},
